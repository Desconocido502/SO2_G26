...
void read_json_file(char* filename) {
    ...
    for (int i = 0; i < cJSON_GetArraySize(json); ++i) {
        ...
        insertUser(users[user_count].account_number, users[user_count].full_name, users[user_count].saldo);
        user_count++;
...
// Función que será ejecutada por cada hilo para cargar usuarios
/*
void* load_users(void* arg) {
    ...
    num_users += user_count - start_index;
